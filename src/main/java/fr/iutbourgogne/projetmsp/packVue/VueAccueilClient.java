...
/**
 * Classe représentant la vue d'accueil (post authentification) pour un client
 *
 * @author Jorick
 */
public class VueAccueilClient extends JPanel {
    ...
    public VueAccueilClient(User p) {
        ...
        // on remplace le texte sur label en ajoutant le nom et prénom du client
    ...
    private class Ecouteur implements ActionListener, MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            if (e.getSource() == labelDeco) {               // s'il clique sur "déconnexion"
                personne.notifyObservateurs("deconnexion");  
            } else if (e.getSource() == labelChangeMdp) {   // s'il clique sur "changer mdp"
